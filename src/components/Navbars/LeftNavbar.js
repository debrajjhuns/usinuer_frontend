                    ...
                    <ul className="menu">
                        ...
                        <li className="sidebar-item">
                            ...
                            <ul className="submenu">
                                <li className="submenu-item ">
                                    <a href={`${process.env.PUBLIC_URL}/documents-trashed`}>
                        ...
                        <li className="sidebar-item">
                            ...
                            <ul className="submenu">
                                <li className="submenu-item ">
                                    ...
                                    <a href={`${process.env.PUBLIC_URL}/outputs-favourite`}>Favorites</a>
                                </li>
								<li className="submenu-item ">
                                    <i className="fa fa-flag" aria-hidden="true"></i>
                                    <a href={`${process.env.PUBLIC_URL}/outputs-flagged`}>Flagged</a>
                                </li>
								<li className="submenu-item ">
                                    <i className="fa fa-trash" aria-hidden="true"></i>
                                    <a href={`${process.env.PUBLIC_URL}/outputs-trashed`}>Trash</a>
                                </li>								
                            </ul>
                        </li>
                    </ul>
